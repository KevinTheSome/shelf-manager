<x-layout title="dashboard">
    ...
    <section class="container mx-auto px-4 py-8">
        <h1 class="text-yellow-900 text-3xl font-bold text-center mb-8">Edit Shelf</h1>
        <div class="bg-yellow-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('shelves.update') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ $shelf->name }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-yellow-900 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
