<x-layout title="dashboard">
    ...
    <section class="container mx-auto px-4 py-8">
        <h1 class="text-yellow-900 text-4xl font-bold text-center mb-8">Create Shelf Storage</h1>
        <div class="bg-yellow-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="/shelf_storage/new" method="POST">
                ...
                <div class="text-center">
                    <button type="submit" class="bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-900 focus:outline-none focus:shadow-outline">Create</button>
                </div>
            </form>
        </div>
    </section>
